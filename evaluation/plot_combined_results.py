...
files_dir = os.path.abspath(os.path.join(base_dir, '..','experiments'))

# ==========================================
# 1. Load Test and Training Files
# ==========================================
test_files = glob.glob(os.path.join(files_dir, '*_Test_Summary.csv'))
train_files = glob.glob(os.path.join(files_dir,'*_Training_Summary.csv'))
...
if not df_test.empty and 'tst_rel_err' in df_test.columns:
    ...
    plot1_name = os.path.join(files_dir ,"Plot_1_Test_Performance.png")
...
if not df_test.empty and 'tst_rel_err' in df_test.columns:
    ...
    plot2_name = os.path.join(files_dir , "Plot_2_Test_Stability.png")
...
# ==========================================
# PLOT 3: Convergence Speed (Using TRAINING)
# ==========================================
if not df_train.empty and 'Stopped_At_Epoch' in df_train.columns:
    ...
    plot3_name = os.path.join(files_dir , "Plot_3_Train_Convergence.png")
