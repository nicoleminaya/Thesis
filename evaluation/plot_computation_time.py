...
csv_path = os.path.join(base_dir, '..', 'experiments', args.file + '.csv')
image_path = os.path.join(base_dir, '..', 'experiments')
...
output_image = os.path.join(image_path, f'{wds_type}_computation_time_chart_{model_suffix}.png')
