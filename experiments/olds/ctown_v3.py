...
class ChebNet(torch.nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.conv1 = ChebConv(in_channels, 60, K=50) # 60, K=200
        self.conv2 = ChebConv(60, 40, K=50) #60, 60 K=200  -- maybe keep channels intacted?
        self.conv3 = ChebConv(40, 20, K=50) # 60, 30, K=20
